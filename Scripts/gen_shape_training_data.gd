...
var COLORS_TO_RGB = [ Color(1, 0, 0), Color(0, 1, 0), Color(0, 0, 1), Color(1, 0.65, 0), Color(0.58, 0, 0.83), Color(1, 1, 1), Color(0, 0, 0), Color(0.54, 0.27, 0.07) ]
# color values for red, green, blue, orange, purple, white, black, brown from imaging_types
...
func makeShapeTarget():
	...
	if letter_color == shape_color:
		letter_color = (letter_color + 3)% len(COLORS_TO_RGB)
	label.modulate = COLORS_TO_RGB[letter_color]
	label.rotate_x(-PI/2)
